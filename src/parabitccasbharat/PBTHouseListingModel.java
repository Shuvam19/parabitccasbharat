...
public class PBTHouseListingModel {
    ...
    private int privatesecurityguard;
    ...
    public int getPrivatesecurityguard() {
        return privatesecurityguard;
    }

    public void setPrivatesecurityguard(int privatesecurityguard) {
    ...
    public void setBurglaralarm(int burglaralarm) {
